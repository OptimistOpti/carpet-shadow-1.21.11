...
// NOTE [PORT 1.21.11] see PORTING_NOTES.md #7.
//  CarpetExtension's API has evolved a bit across carpet 1.4.11x -> 1.4.194 (e.g. the deprecated
//  CarpetExtension::customSettingsManager was removed in favor of extensionSettingsManager).
//  Double check this class + CarpetExtension's interface for removed/renamed default methods.
